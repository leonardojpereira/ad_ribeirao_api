...
namespace Project.WebApi.Controllers
{
    ...
    public class UserController : BaseController
    {
        ...
        /// <param name="filter">Filtro opcional para busca (ex: Username, e-mail).</param>
        ...
        // [SwaggerOperation(Summary = "Obtém um usuário por ID", Description = "Retorna um usuário específico com base no ID.")]
